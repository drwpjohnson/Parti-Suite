...
setenv PRGDIR "/uufs/chpc.utah.edu/common/home/u0034962/king2/bin"
#setenv BINDIR "/uufs/chpc.utah.edu/common/home/u0034962/geophys/wjohnson/submit_bin"
setenv BINDIR "/uufs/chpc.utah.edu/common/home/u0034962/king2/bin"
...
# For Python binary----------------------------------------------------------
set PROGRAM="python3 $PRGDIR/traj_jet.py"
set OUTPUTDIR=`pwd`
...
@ IPART = 1
while ($IPART <= $NPART)
  echo "/usr/bin/python3 $PRGDIR/traj_jet.py $NPART $IPART $OUTPUTDIR" >> job.list
  @ IPART = $IPART + 1
end
...
set FILENAMES=(JETFLUXATT JETFLUXREM JETFLUXEX)
