...
%% vdW Functions
%vdW colloid-plate
[F_vdW_colloid_plate]=F_vdW_SP_colloid_plate(H,A132,a1,lambdavdW);%[N]
[deltaG_vdW_colloid_plate]=E_vdW_SP_colloid_plate(H,A132,a1,lambdavdW);%[J]
%vdW RMODE
    RMODE=1; %insert RMODE here 
[F_vdW_RMODE1]=F_vdW_SP_RMODE(H,n,A132,aasp,a1,lambdavdW,RMODE);%[N]
[deltaG_vdW_RMODE1]=E_vdW_SP_RMODE(H,n,A132,aasp,a1,lambdavdW,RMODE);%[J]
    RMODE=2; %insert RMODE here 
[F_vdW_RMODE2]=F_vdW_SP_RMODE(H,n,A132,aasp,a1,lambdavdW,RMODE);%[N]
[deltaG_vdW_RMODE2]=E_vdW_SP_RMODE(H,n,A132,aasp,a1,lambdavdW,RMODE);%[J]
    RMODE=3; %insert RMODE here 
[F_vdW_RMODE3]=F_vdW_SP_RMODE(H,n*Nco,A132,aasp,a1,lambdavdW,RMODE);%[N]
[deltaG_vdW_RMODE3]=E_vdW_SP_RMODE(H,n*Nco,A132,aasp,a1,lambdavdW,RMODE);%[J]
...
if system==1
    ...
    if T1==0||T2==0 %Colloid coating - Collector
        ...
        Ac_1p_2=A1p_2-A2_3-A1p_2p+A2p_3;
    end
    
    if T1==0||T2==0 %Colloid - Collector
        Ac_1_2=0;
        else
        Ac_1_2=A1_2-A1p_2-A1_2p+A1p_2p;
    end
end
[F_vdW_CS_1]=F_vdW_SP_coated_systems(H,a1,lambdavdW,...
...
if system==2
    ...
    [F_vdW_CS_2]=F_vdW_SP_coated_systems(H,a1,lambdavdW,...
                    T1,T2,Ac_1p_2p,Ac_1_2p,Ac_1p_2,Ac_1_2,system); %[N]
     
    [E_vdW_CS_2]=E_vdW_SP_coated_systems(H,a1,lambdavdW,...
                    T1,T2,Ac_1p_2p,Ac_1_2p,Ac_1p_2,Ac_1_2,system);%[J]
end
...
if system==3 %Layered_colloid_Collector
    ...
    if T2>0 %Colloid - Surface
        ...
        Ac_1_2=A1_2-A1p_2-A1_3+A1p_3;
    end
    
    [F_vdW_CS_3]=F_vdW_SP_coated_systems(H,a1,lambdavdW,...
                    T1,T2,Ac_1p_2p,Ac_1_2p,Ac_1p_2,Ac_1_2,system); %[N]
    
    [E_vdW_CS_3]=E_vdW_SP_coated_systems(H,a1,lambdavdW,...
                    T1,T2,Ac_1p_2p,Ac_1_2p,Ac_1p_2,Ac_1_2,system);%[J]
end
...
%     datadir=strcat(pwd,'\');   
% end
% filename = strcat(datadir,'SPoutput_vdW.xlsx');
% % write header
