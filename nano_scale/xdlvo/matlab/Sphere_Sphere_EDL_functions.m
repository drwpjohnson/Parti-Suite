...
%% EDL Functions
%EDL colloid-plate
[deltaG_EDL_colloid_plate]=E_EDL_SS_colloid_plate(H,theta,eps,K,kB,T,z,zeta1,e_charge,zeta2,a1,a2);%[J]
[F_EDL_colloid_plate]=F_EDL_SS_colloid_plate(H,theta,eps,K,kB,T,z,zeta1,e_charge,zeta2,a1,a2);%[N]
%EDL RMODE
    RMODE=1;%insert RMODE here
[F_EDL_RMODE1]=F_EDL_SS_RMODE(H,theta,a2,eps,K,kB,T,z,zeta1,e_charge,zeta2,aasp,a1,RMODE,n);%[N]
[deltaG_EDL_RMODE1]=E_EDL_SS_RMODE(H,theta,a2,eps,K,kB,T,z,zeta1,e_charge,zeta2,aasp,a1,RMODE,n);%[J]
    RMODE=2;%insert RMODE here
[F_EDL_RMODE2]=F_EDL_SS_RMODE(H,theta,a2,eps,K,kB,T,z,zeta1,e_charge,zeta2,aasp,a1,RMODE,n);%[N]
[deltaG_EDL_RMODE2]=E_EDL_SS_RMODE(H,theta,a2,eps,K,kB,T,z,zeta1,e_charge,zeta2,aasp,a1,RMODE,n);%[J]
    RMODE=3;%insert RMODE here
[F_EDL_RMODE3]=F_EDL_SS_RMODE(H,theta,a2,eps,K,kB,T,z,zeta1,e_charge,zeta2,aasp,a1,RMODE,n*Nco);%[N]
[deltaG_EDL_RMODE3]=E_EDL_SS_RMODE(H,theta,a2,eps,K,kB,T,z,zeta1,e_charge,zeta2,aasp,a1,RMODE,n*Nco);%[J]
...
filename = strcat(datadir,'SSoutput_EDL.xlsx');
% write header
